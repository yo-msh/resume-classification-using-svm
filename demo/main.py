...
def predict():
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            matching_substring = next((substring for substring in substring_values if substring in file_name), None)

            if matching_substring:
                prediction_value = substring_values[matching_substring]
                return render_template('result.html', category=prediction_value)
